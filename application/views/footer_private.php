  <footer class="main-footer no-print">
    ...
    <strong>&copy; Cotton Ball 2020-2021 | </strong> Todos los derechos reservados.
  </footer>
...
<!-- ./wrapper -->
  ...
  <script src="<?=base_url("data/plugins/datatables-responsive/js/dataTables.responsive.min.js")?>"></script>
  <script src="<?=base_url("data/plugins/datatables-responsive/js/responsive.bootstrap4.min.js")?>"></script>
