...
<head>
  ...
  <title>Cotton Ball | Embajador</title>
...
.embajador-form .form-control[type=text]{
...
.embajador-form .form-control[type=email]{
  background-color: #fff;
  display: inline-block;
  transition: .5s;
  font-family: sans-serif;
...
<form id="formulario_quiero_ser_embajador" method="post" >
...
$("#formulario_quiero_ser_embajador").submit( function(e) {
    e.preventDefault();
    ...
    submitHandler: function( form ) {
        ...
        $.ajax({
            url: url + "Principal/send_embajador_request",
            data: data,
            cache: false,
            contentType: false,
            processData: false,
