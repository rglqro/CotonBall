...
<form id="formulario_quiero_ser_conductor" method="post" >
    ...
    <div class="form-row">
      <div class="col">
        <input type="text" class="form-control" id="name_driver" name="name_driver" placeholder="Digita Nombre Completo" style="font-family: sans-serif;">
      </div>
      <div class="col">
        <input type="email" class="form-control" id="email_driver" name="email_driver" placeholder="Digita tu Email"  style="font-family: sans-serif;">
      </div>
